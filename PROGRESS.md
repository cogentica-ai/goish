...
## net/http — 639 / 639 by name, 726 / 754 by declaration (96.3%)
...
the same tree at **726/754 (96.3%)** — root 538/566, `httputil` 55/55 —
and **none of the 28 short carries an anchor anywhere in its package**.
...
not. ROADMAP §2b-vi lists all 28; `httputil` is
