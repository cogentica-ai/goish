...
## net/http — 639 / 639 by name, 726 / 744 by declaration (97.6%)
...
the same tree at **726/744 (97.6%)** — root 538/556, `httputil` 55/55 —
and **none of the 18 short carries an anchor anywhere in its package**.
...
not. ROADMAP §2b-vi lists all 18; `httputil` is
