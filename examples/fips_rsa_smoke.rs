...
const N: &[u8] = &[
    0xbf, 0x97, 0x52, 0xdb, 0x54, 0x93, 0x8b, 0xd8, 0x6a, 0x57, 0x4f, 0xd5, 0xdf, 0x6e, 0xf9, 0x96,
    0xcc, 0xdd, 0x08, 0x8d, 0x90, 0x50, 0xfd, 0x4f, 0x18, 0x7a, 0xcf, 0xb0, 0x4a, 0x91, 0x6d, 0xba,
    0x82, 0xad, 0xa0, 0x44, 0xa4, 0x2c, 0xa4, 0xd5, 0x9d, 0xd1, 0xdb, 0xbd, 0x03, 0x01, 0x29, 0x83,
    0x0e, 0x90, 0x49, 0xee, 0x45, 0x61, 0x3a, 0x01, 0xc7, 0xa3, 0x46, 0x24, 0x70, 0xc1, 0x17, 0x59,
];
const D: &[u8] = &[
    0x83, 0x1d, 0x5a, 0x14, 0xc3, 0x92, 0x9d, 0xd7, 0xa3, 0x1e, 0xd1, 0x81, 0xfa, 0x00, 0x86, 0x4a,
    0x4f, 0x34, 0xcc, 0xcf, 0xa4, 0x7d, 0xe8, 0x7c, 0xa2, 0xb2, 0x19, 0x43, 0xfa, 0x24, 0x00, 0x44,
    0xbe, 0x5d, 0x26, 0x6c, 0x29, 0x36, 0x81, 0xe4, 0xa7, 0x9c, 0x17, 0x05, 0x6b, 0xf0, 0x44, 0x3e,
    0x0d, 0xfd, 0x28, 0xca, 0x3a, 0xf5, 0x76, 0xbb, 0x2a, 0xa2, 0xff, 0x44, 0x0e, 0x34, 0x90, 0x01,
];
const P: &[u8] = &[
    0xde, 0x57, 0x3b, 0x62, 0xb3, 0x57, 0x5a, 0xf9, 0x98, 0x2d, 0xc8, 0x58, 0x60, 0xc3, 0xd8, 0xf3,
    0x23, 0x93, 0x98, 0x07, 0x14, 0x7b, 0xd3, 0xe7, 0x56, 0xf5, 0x90, 0x9f, 0x99, 0xab, 0xac, 0x59,
];
const Q: &[u8] = &[
    0xdc, 0x98, 0x65, 0x5a, 0xc4, 0x9a, 0xba, 0xfb, 0xd4, 0x51, 0xfe, 0x09, 0x70, 0x49, 0x1e, 0x1d,
    0x21, 0x63, 0x54, 0x89, 0x57, 0xc7, 0xb8, 0x2d, 0xf4, 0x12, 0xe6, 0x48, 0x05, 0x07, 0x63, 0x01,
];
const DP: &[u8] = &[
    0x9e, 0xb3, 0xcf, 0x3c, 0xbd, 0x5c, 0x5e, 0x20, 0x88, 0x62, 0x2d, 0x7d, 0xff, 0xdb, 0xeb, 0x70,
    0x69, 0x75, 0x81, 0x6f, 0x94, 0x4c, 0x6a, 0xcd, 0xd7, 0x01, 0x43, 0x30, 0xd8, 0xa4, 0x74, 0x49,
];
const DQ: &[u8] = &[
    0x15, 0xab, 0x8a, 0xd9, 0x5d, 0xd2, 0xed, 0x67, 0x6b, 0xb6, 0x1a, 0x44, 0x87, 0x19, 0x47, 0xb2,
    0x08, 0xe3, 0x9f, 0x1c, 0x56, 0xd9, 0x31, 0xc8, 0xa1, 0xdf, 0x71, 0x6b, 0xc5, 0xc2, 0xb2, 0x01,
];
const QINV: &[u8] = &[
    0x73, 0xb8, 0x2d, 0xc5, 0xc9, 0xb5, 0xc3, 0xe0, 0x99, 0x57, 0x69, 0x4a, 0xac, 0x66, 0xe3, 0x43,
    0x02, 0x7a, 0xb3, 0xb5, 0x2c, 0x45, 0x37, 0x96, 0x1f, 0x11, 0x10, 0x85, 0x1d, 0x8b, 0x66, 0x32,
];
const E: i64 = 65537;

// A 512-bit-minus-a-bit plaintext block (< N), used for round-trips.
const MSG: &[u8] = &[
    0x42, 0x13, 0x37, 0xca, 0xfe, 0xba, 0xbe, 0xde, 0xad, 0xbe, 0xef, 0x01, 0x23, 0x45, 0x67, 0x89,
    0xab, 0xcd, 0xef, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1a, 0x1b, 0x1c,
];
...
const REF_SIG_V15: &[u8] = &[
    0x2a, 0x10, 0x53, 0xff, 0xf3, 0x92, 0x44, 0x9e, 0x6b, 0x81, 0x18, 0x8b, 0xb1, 0x16, 0xe8, 0xee,
    0xf3, 0xf4, 0x5b, 0xff, 0xc3, 0x94, 0xf4, 0xbd, 0x2d, 0x6e, 0x93, 0x05, 0xb5, 0x5e, 0xe2, 0x95,
    0x1c, 0xf0, 0xfa, 0x0b, 0xb5, 0x9c, 0x3a, 0xef, 0x3e, 0x92, 0xa2, 0x11, 0x0e, 0x67, 0x82, 0x8f,
    0xa0, 0xba, 0xa6, 0xa5, 0xc4, 0x4b, 0x29, 0x29, 0x96, 0x72, 0x10, 0x7a, 0x35, 0x0a, 0xe3, 0xdf,
];
...
const REF_SIG_MD5SHA1: &[u8] = &[
    0x11, 0x7c, 0x9a, 0x22, 0x93, 0xe4, 0x70, 0xdd, 0x27, 0x46, 0x84, 0x87, 0xff, 0xf4, 0x04, 0x63,
    0x90, 0xd0, 0xe9, 0x27, 0xf6, 0xd7, 0xd7, 0xb0, 0x60, 0x6d, 0x33, 0x02, 0xf6, 0x57, 0xe6, 0x2f,
    0x67, 0x84, 0x7d, 0xf9, 0x44, 0x18, 0x06, 0xe2, 0xaa, 0xac, 0x40, 0xe7, 0x96, 0x95, 0xe4, 0x6f,
    0x45, 0xfb, 0x72, 0xdc, 0x9c, 0xb9, 0xce, 0x15, 0x4f, 0x50, 0x87, 0x10, 0xbf, 0x7e, 0x33, 0x43,
];
...
const REF_SIG_RIPEMD160: &[u8] = &[
    0x5b, 0xdb, 0x74, 0xbb, 0x17, 0xfc, 0xdb, 0x89, 0xcc, 0xb2, 0xb1, 0x8c, 0x36, 0x78, 0xfb, 0xb6,
    0x2d, 0x73, 0xc3, 0x4e, 0x15, 0xa8, 0xe9, 0x26, 0x55, 0xb0, 0x71, 0x57, 0xe6, 0x13, 0x38, 0x42,
    0x4e, 0x37, 0x18, 0x93, 0x24, 0x95, 0x6b, 0x54, 0xbd, 0x4f, 0xfc, 0x9e, 0x2a, 0x09, 0xb8, 0xde,
    0x95, 0x6b, 0xd2, 0xab, 0x58, 0xba, 0x97, 0x57, 0x2e, 0x85, 0x70, 0xdf, 0xda, 0x9a, 0x59, 0x5e,
];
...
fn test_20_pkcs1v15_ripemd160() {
    ...
    let ev = rsa::VerifyPKCS1v15(
        &k.PublicKey(),
        goish::crypto::RIPEMD160,
        digest,
        sig.clone(),
    );
...
fn test_15_oaep_roundtrip() {
    ...
    let (ct, e1) = rsa::EncryptOAEP(oaep_lhash(), &mut mgf, &mut rng, &pubk, from_bytes(small));
    ...
    let rt_ok = if ge.IsNil() {
        ...
        let (ct2, ce) =
            rsa::EncryptOAEP(oaep_lhash(), &mut mgf2, &mut rng, &bpub, from_bytes(small));
...
fn test_16_oaep_tampered() {
    ...
    let mut mgf = sha256::New();
    let (ct, ce) = rsa::EncryptOAEP(oaep_lhash(), &mut mgf, &mut rng, &bpub, from_bytes(small));
    if !ce.IsNil() {
        write_result(16, b"DecryptOAEP rejects tamper   ", false);
        fail();
        return;
...
fn test_6_decrypt_without_check() {
    ...
    let ok = e1.IsNil()
        && e2.IsNil()
        && slice_eq_trim(&pt1, &from_bytes(MSG))
...
fn test_9_without_crt() {
    ...
    let (ct, e1) = rsa::encrypt(&pubk, from_bytes(MSG));
    let (pt, e2) = rsa::decrypt(&k, ct, false);
    let ok = e1.IsNil() && e2.IsNil() && k.dP == goish::nil && slice_eq_trim(&pt, &from_bytes(MSG));
...
fn test_10_generate_key() {
    ...
    let ok = ok_size && e1.IsNil() && e2.IsNil() && slice_eq_trim(&pt, &from_bytes(small));
