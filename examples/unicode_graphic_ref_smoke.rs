...
const LATIN1: [u16; 256] = [
    ...
    0x0001, 0x0011, 0x0011, 0x0011, 0x0011, 0x0011, 0x0001, 0x0001,
    0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001,
    0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001,
    0x0190, 0x0182, 0x0182, 0x0182, 0x0188, 0x0182, 0x0182, 0x0182,
    0x0182, 0x0182, 0x0182, 0x0188, 0x0182, 0x0182, 0x0182, 0x0182,
    0x0584, 0x0584, 0x0584, 0x0584, 0x0584, 0x0584, 0x0584, 0x0584,
    0x0584, 0x0584, 0x0182, 0x0182, 0x0188, 0x0188, 0x0188, 0x0182,
    0x0182, 0x03a0, 0x03a0, 0x03a0, 0x03a0, 0x03a0, 0x03a0, 0x03a0,
    0x03a0, 0x03a0, 0x03a0, 0x03a0, 0x03a0, 0x03a0, 0x03a0, 0x03a0,
    0x03a0, 0x03a0, 0x03a0, 0x03a0, 0x03a0, 0x03a0, 0x03a0, 0x03a0,
    0x03a0, 0x03a0, 0x03a0, 0x0182, 0x0182, 0x0182, 0x0188, 0x0182,
    0x0188, 0x03c0, 0x03c0, 0x03c0, 0x03c0, 0x03c0, 0x03c0, 0x03c0,
    0x03c0, 0x03c0, 0x03c0, 0x03c0, 0x03c0, 0x03c0, 0x03c0, 0x03c0,
    0x03c0, 0x03c0, 0x03c0, 0x03c0, 0x03c0, 0x03c0, 0x03c0, 0x03c0,
    0x03c0, 0x03c0, 0x03c0, 0x0182, 0x0188, 0x0182, 0x0188, 0x0001,
    0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0011, 0x0001, 0x0001,
    0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001,
    0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001,
    0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001,
    0x0110, 0x0182, 0x0188, 0x0188, 0x0188, 0x0188, 0x0188, 0x0182,
    0x0188, 0x0188, 0x0380, 0x0182, 0x0188, 0x0000, 0x0188, 0x0188,
    0x0188, 0x0188, 0x0184, 0x0184, 0x0188, 0x03c0, 0x0182, 0x0182,
    0x0188, 0x0184, 0x0380, 0x0182, 0x0184, 0x0184, 0x0184, 0x0182,
    0x03a0, 0x03a0, 0x03a0, 0x03a0, 0x03a0, 0x03a0, 0x03a0, 0x03a0,
    0x03a0, 0x03a0, 0x03a0, 0x03a0, 0x03a0, 0x03a0, 0x03a0, 0x03a0,
    0x03a0, 0x03a0, 0x03a0, 0x03a0, 0x03a0, 0x03a0, 0x03a0, 0x0188,
    0x03a0, 0x03a0, 0x03a0, 0x03a0, 0x03a0, 0x03a0, 0x03a0, 0x03c0,
    0x03c0, 0x03c0, 0x03c0, 0x03c0, 0x03c0, 0x03c0, 0x03c0, 0x03c0,
    0x03c0, 0x03c0, 0x03c0, 0x03c0, 0x03c0, 0x03c0, 0x03c0, 0x03c0,
    0x03c0, 0x03c0, 0x03c0, 0x03c0, 0x03c0, 0x03c0, 0x03c0, 0x0188,
    0x03c0, 0x03c0, 0x03c0, 0x03c0, 0x03c0, 0x03c0, 0x03c0, 0x03c0,
];
...
fn main() {
    ...
    //    carrying an extra one, moves exactly one of these.
    {
        ...
        if ok {
            ...
            while k < 13 {
                if counts[k] != SCOUNTS[k].2 {
                    fmt::Println!("     ", SCOUNTS[k].0, "got", counts[k], "want", SCOUNTS[k].2);
                }
                k += 1;
            }
            failed += 1;
