...
fn main() {
    ...
    check(
        "1",
        time::Date(2024, 1, 1, 0, 0, 0, 0, goish::time::UTC),
        2024,
        1,
        &mut failed,
    );
    ...
    check(
        "2",
        time::Date(2024, 12, 31, 12, 0, 0, 0, goish::time::UTC),
        2025,
        1,
        &mut failed,
    );
    ...
    check(
        "3",
        time::Date(2023, 1, 1, 0, 0, 0, 0, goish::time::UTC),
        2022,
        52,
        &mut failed,
    );
    ...
    check(
        "4",
        time::Date(2020, 12, 31, 23, 0, 0, 0, goish::time::UTC),
        2020,
        53,
        &mut failed,
    );
    ...
    check(
        "5",
        time::Date(2021, 1, 1, 0, 0, 0, 0, goish::time::UTC),
        2020,
        53,
        &mut failed,
    );
    ...
    check(
        "6",
        time::Date(2024, 6, 15, 0, 0, 0, 0, goish::time::UTC),
        2024,
        24,
        &mut failed,
    );
    ...
    check(
        "7",
        time::Date(1970, 1, 1, 0, 0, 0, 0, goish::time::UTC),
        1970,
        1,
        &mut failed,
    );
    ...
    check(
        "8",
        time::Date(1969, 12, 29, 0, 0, 0, 0, goish::time::UTC),
        1970,
        1,
        &mut failed,
    );
    ...
    check(
        "9",
        time::Date(2026, 12, 28, 0, 0, 0, 0, goish::time::UTC),
        2026,
        53,
        &mut failed,
    );
    ...
    check(
        "10",
        time::Date(2027, 1, 3, 0, 0, 0, 0, goish::time::UTC),
        2026,
        53,
        &mut failed,
    );
