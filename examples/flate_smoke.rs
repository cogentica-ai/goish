...
static EMIT_LVL_BAD: AtomicUsize = AtomicUsize::new(0);

// The same byte-for-byte comparison as check 11, at the levels that do
// not take the dynamic-Huffman path: NoCompression exercises
// `writeStoredHeader`, HuffmanOnly exercises `writeBlockHuff`, and
// BestSpeed goes through the deflate-fast matcher. Check 11 alone
// covered only DefaultCompression, and a wrong complement in
// `writeStoredHeader` once survived it — a stored block still
// round-trips through goish's own decoder, because the decoder reads
// back exactly what the encoder wrote. Only Go's bytes catch it.
fn check_emit_at(kind: Corpus, n: usize, level: int, want: &[u8]) {
    let raw = corpus(kind, n);
    let (got, ok) = deflate(&raw, level);
    if !ok || !eq(&got, want) {
        EMIT_LVL_BAD.fetch_add(1, Ordering::AcqRel);
    }
}

fn test_12_bytes_match_go_levels() {
    check_emit_at(
        Corpus::Abc3,
        9,
        flate::NoCompression,
        b"\x00\x09\x00\xf6\xff\x61\x62\x63\x61\x62\x63\x61\x62\x63\x01\
        \x00\x00\xff\xff",
    );
    check_emit_at(
        Corpus::Run1000,
        1000,
        flate::NoCompression,
        b"\x00\xe8\x03\x17\xfc\x61\x61\x61\x61\x61\x61\x61\x61\x61\x61\
    ...
    check_emit_at(
        ...
        2000,
        flate::NoCompression,
        b"\x00\xd0\x07\x2f\xf8\x61\x62\x63\x64\x65\x66\x67\x61\x62\x63\
        \x64\x65\x66\x67\x61\x62\x63\x64\x65\x66\x67\x61\x62\x63\x64\
        \x65\x66\x67\x61\x62\x63\x64\x65\x66\x67\x61\x62\x63\x64\x65\
        \x66\x67\x61\x62\x63\x64\x65\x66\x67\x61\x62\x63\x64\x65\x66\
        \x67\x61\x62\x63\x64\x65\x66\x67\x61\x62\x63\x64\x65\x66\x67\
        \x61\x62\x63\x64\x65\x66\x67\x61\x62\x63\x64\x65\x66\x67\x61\
        \x62\x63\x64\x65\x66\x67\x61\x62\x63\x64\x65\x66\x67\x61\x62\
        \x63\x64\x65\x66\x67\x61\x62\x63\x64\x65\x66\x67\x61\x62\x63\
        \x64\x65\x66\x67\x61\x62\x63\x64\x65\x66\x67\x61\x62\x63\x64\
        \x65\x66\x67\x61\x62\x63\x64\x65\x66\x67\x61\x62\x63\x64\x65\
        \x66\x67\x61\x62\x63\x64\x65\x66\x67\x61\x62\x63\x64\x65\x66\
        \x67\x61\x62\x63\x64\x65\x66\x67\x61\x62\x63\x64\x65\x66\x67\
        ...
        \x61\x62\x63\x64\x65\x66\x67\x61\x62\x63\x64\x65\x66\x67\x61\
        \x62\x63\x64\x65\x66\x67\x61\x62\x63\x64\x65\x66\x67\x61\x62\
        \x63\x64\x65\x66\x67\x61\x62\x63\x64\x65\x01\x00\x00\xff\xff",
    );
    check_emit_at(
        Corpus::Abc3,
        9,
    ...
    check_emit_at(
        ...
        1000,
        flate::BestSpeed,
        b"\xec\xc0\x81\x10\x00\x00\x00\x02\x31\xd6\xfc\x25\xf2\xf8\xdb\
        \x06\xe4\x3d\x00\x00\xff\xff",
    );
    check_emit_at(
        Corpus::Period7,
        2000,
        flate::BestSpeed,
        b"\xec\xd0\x39\x11\x00\x30\x08\x00\x30\xad\x2d\x9f\x7f\x07\xe8\
        \xe0\x2e\x53\xf6\xbc\x1f\x59\x3d\x50\xa0\x40\x81\x02\x05\x0a\
        \x0e\x17\x6c\x00\x00\x00\xff\xff",
    );
    check_emit_at(
        Corpus::Abc3,
        9,
    ...
    check_emit_at(
        ...
        2000,
        flate::BestCompression,
        b"\x4a\x4c\x4a\x4e\x49\x4d\x4b\x1f\xa5\x46\xa9\x51\x6a\x94\x1a\
        \xa5\x46\xa9\x51\x6a\x08\x53\x80\x00\x00\x00\xff\xff",
    );
    check_emit_at(
        Corpus::Abc3,
        9,
    ...
    check_emit_at(
        ...
        1000,
        flate::HuffmanOnly,
        b"\x04\xc0\x81\x00\x00\x00\x00\x00\x90\x56\xff\x13\x00\x00\x00\
        ...
        \x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\
        \x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\
        \x00\x00\x0c\x00\x00\xff\xff",
    );
    check_emit_at(
        Corpus::Period7,
        2000,
        flate::HuffmanOnly,
        b"\x04\xc0\x07\x01\x00\x00\x08\x02\xc1\xac\x8c\x97\xfe\x0d\x3c\
        \x39\xe5\x26\xa7\xdc\xe4\x94\x9b\x9c\x72\x93\x53\x6e\x72\xca\
        \x4d\x4e\xb9\xc9\x29\x37\x39\xe5\x26\xa7\xdc\xe4\x94\x9b\x9c\
        \x72\x93\x53\x6e\x72\xca\x4d\x4e\xb9\xc9\x29\x37\x39\xe5\x26\
        \xa7\xdc\xe4\x94\x9b\x9c\x72\x93\x53\x6e\x72\xca\x4d\x4e\xb9\
        \xc9\x29\x37\x39\xe5\x26\xa7\xdc\xe4\x94\x9b\x9c\x72\x93\x53\
        \x6e\x72\xca\x4d\x4e\xb9\xc9\x29\x37\x39\xe5\x26\xa7\xdc\xe4\
        \x94\x9b\x9c\x72\x93\x53\x6e\x72\xca\x4d\x4e\xb9\xc9\x29\x37\
        \x39\xe5\x26\xa7\xdc\xe4\x94\x9b\x9c\x72\x93\x53\x6e\x72\xca\
        \x4d\x4e\xb9\xc9\x29\x37\x39\xe5\x26\xa7\xdc\xe4\x94\x9b\x9c\
        \x72\x93\x53\x6e\x72\xca\x4d\x4e\xb9\xc9\x29\x37\x39\xe5\x26\
        \xa7\xdc\xe4\x94\x9b\x9c\x72\x93\x53\x6e\x72\xca\x4d\x4e\xb9\
    ...
    let bad = EMIT_LVL_BAD.load(Ordering::Acquire);
    write_result(12, b"deflate bytes == Go's, lvls", bad == 0);
    if bad != 0 {
        fail();
    }
}
