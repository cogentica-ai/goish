...
fn main() {
    ...
    // 2G public key:
    let pub_2g_x: [u8; 32] = [
        0xBA, 0x2F, 0xB0, 0xD2, 0x64, 0x05, 0x78, 0xA8, 0xF9, 0xD5, 0xB2, 0xCD, 0x89, 0xED, 0xF2, 0x15,
        0xEA, 0xC0, 0x9E, 0xD1, 0x0C, 0x72, 0xE7, 0x83, 0xA4, 0x60, 0xBA, 0x2E, 0xB4, 0x29, 0x3C, 0x93,
    ];
    let pub_2g_y: [u8; 32] = [
        0x50, 0x0F, 0x23, 0x78, 0x6A, 0x50, 0x4C, 0xFD, 0xB4, 0x53, 0xC5, 0x28, 0xE7, 0xBF, 0xA8, 0x63,
        0x49, 0x50, 0x95, 0x74, 0xF9, 0x3C, 0x38, 0x08, 0x57, 0x95, 0x27, 0xEB, 0xC3, 0xA1, 0x94, 0x71,
    ];
    // 3G public key:
    let pub_3g_x: [u8; 32] = [
        0xA6, 0x89, 0xDB, 0xC7, 0xFE, 0x28, 0xFA, 0x2C, 0x1C, 0x1B, 0x53, 0xD7, 0x8F, 0xC9, 0xFB, 0x80,
        0x7F, 0xD0, 0xDA, 0x55, 0xEA, 0x8B, 0x76, 0x2E, 0x18, 0xF8, 0x2E, 0x4E, 0xA6, 0x13, 0x73, 0x7B,
    ];
    let pub_3g_y: [u8; 32] = [
        0x6E, 0x4E, 0x17, 0x1E, 0x17, 0x7F, 0xD2, 0x94, 0x12, 0x98, 0x11, 0xBA, 0xBE, 0x2B, 0xEE, 0x0C,
        0xA4, 0xB5, 0x83, 0x82, 0xE4, 0x7B, 0x64, 0x1B, 0x4D, 0x10, 0x34, 0xDC, 0xFE, 0x23, 0xCB, 0x4F,
    ];
    // 6G x-coordinate (expected shared secret):
    let z_6g_x: [u8; 32] = [
        0xB2, 0xEF, 0xF2, 0xF1, 0x10, 0xB7, 0x6E, 0x2B, 0xB2, 0xC0, 0x23, 0x05, 0xE0, 0x9F, 0x85, 0xA7,
        0xC7, 0x37, 0x25, 0x24, 0xB4, 0xCB, 0xB5, 0x19, 0xBB, 0x6A, 0x1B, 0x56, 0x50, 0x96, 0x16, 0x7D,
    ];
