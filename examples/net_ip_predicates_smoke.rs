...
fn main() {
    ...
    // 1. IsUnspecified — 0.0.0.0 only.
    {
        ...
        {
            fmt::Println!("[ 1] IsUnspecified             PASS");
        } else {
            fmt::Println!("[ 1] IsUnspecified             FAIL");
            failed += 1;
        }
    }
    ...
    // 2. IsLoopback — 127.0.0.0/8.
    {
        ...
        {
            fmt::Println!("[ 2] IsLoopback                PASS");
        } else {
            fmt::Println!("[ 2] IsLoopback                FAIL");
            failed += 1;
        }
    }
    ...
    // 3. IsPrivate — RFC 1918 ranges.
    {
        ...
        {
            fmt::Println!("[ 3] IsPrivate RFC 1918        PASS");
        } else {
            fmt::Println!("[ 3] IsPrivate RFC 1918        FAIL");
            failed += 1;
        }
    }
    ...
    // 4. IsMulticast — 224.0.0.0/4.
    {
        ...
        {
            fmt::Println!("[ 4] IsMulticast               PASS");
        } else {
            fmt::Println!("[ 4] IsMulticast               FAIL");
            failed += 1;
        }
    }
    ...
    // 5. IsLinkLocalMulticast — 224.0.0.0/24.
    {
        ...
        {
            fmt::Println!("[ 5] IsLinkLocalMulticast      PASS");
        } else {
            fmt::Println!("[ 5] IsLinkLocalMulticast      FAIL");
            failed += 1;
        }
    }
    ...
    // 6. IsLinkLocalUnicast — 169.254.0.0/16.
    {
        ...
        {
            fmt::Println!("[ 6] IsLinkLocalUnicast        PASS");
        } else {
            fmt::Println!("[ 6] IsLinkLocalUnicast        FAIL");
            failed += 1;
        }
    }
    ...
    // 7. nil-IP — all predicates false.
    {
            ...
            && !nil_ip.IsLinkLocalMulticast() && !nil_ip.IsLinkLocalUnicast()
        {
            ...
            fmt::Println!("[ 7] nil-IP all-false          FAIL");
            failed += 1;
        }
    }
