...
use super::ecdsa::{
    bits2octets, Curve, Point, PrivateKey, PublicKey, Signature, Verify, P256,
};
    ...
    fips140::CAST("ECDSA P-256 SHA2-512 sign and verify", || {
        ...
        let want = Signature {
            R: slice::__from_vec(alloc::vec![
                0x33, 0x64, 0x96, 0xff, 0x8a, 0xfe, 0xaa, 0x0b, 0x2c, 0x4a, 0x1a, 0x97, 0x77,
                0xcc, 0x84, 0xa5, 0x7e, 0x88, 0x1f, 0x16, 0x2d, 0xe0, 0x29, 0xf7, 0x62, 0xc2,
                0x34, 0x18, 0x10, 0x9c, 0x69, 0x8a,
            ]),
            S: slice::__from_vec(alloc::vec![
                0x97, 0x53, 0x2e, 0x13, 0x6e, 0xd0, 0x9b, 0x30, 0x8a, 0xdf, 0x4f, 0xe0, 0x54,
                0x82, 0x14, 0x83, 0x5e, 0x93, 0xc7, 0x79, 0x4b, 0x18, 0xa3, 0xf1, 0x8a, 0x60,
                0xae, 0x52, 0x31, 0xe4, 0x2e, 0x4e,
            ]),
        };
        let mut drbg = newDRBG(
            sha512::NewHash,
...
pub(super) fn fipsSelfTestDeterministic() {
    ...
    fips140::CAST("DetECDSA P-256 SHA2-512 sign", || {
        ...
        let want = Signature {
            R: slice::__from_vec(alloc::vec![
                0x9f, 0xc3, 0x83, 0x32, 0x6e, 0xd9, 0x4f, 0x8e, 0x24, 0xa0, 0x19, 0xef, 0x1d,
                0x3a, 0xc3, 0x55, 0xdd, 0x4b, 0x98, 0xae, 0x78, 0xa7, 0xaf, 0xd3, 0xfd, 0xf3,
                0x22, 0x1c, 0x8b, 0xd6, 0x11, 0x7b,
            ]),
            S: slice::__from_vec(alloc::vec![
                0xd6, 0x52, 0x87, 0x41, 0x71, 0xbd, 0x66, 0xd1, 0xaf, 0x6c, 0x61, 0xdd, 0xd8,
                0xa7, 0xbb, 0xd2, 0xf7, 0xd5, 0x47, 0x70, 0xe9, 0xe4, 0xac, 0x0a, 0xb9, 0xfa,
                0x0f, 0xbd, 0x3b, 0x9b, 0xc2, 0xfe,
            ]),
        };
        let mut drbg = newDRBG(
            sha512::NewHash,
