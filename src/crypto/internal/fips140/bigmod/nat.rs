// go: file crypto/internal/fips140/bigmod/nat.go decls: not, ctMask, ctEq, bigEndianUint, NewNat, expand, reset, resetToBytes, trim, set, Bits, Bytes, SetBytes, SetOverflowingBytes, setBytes, SetUint, Equal, IsZero, IsOne, IsMinusOne, IsOdd, TrailingZeroBitsVarTime, cmpGeq, assign, add, sub, ShiftRightVarTime, BitLenVarTime, resetFor, ExpandFor, shiftIn, Mod, maybeSubtractModulus, Sub, SubOne, Add, montgomeryRepresentation, montgomeryReduction, montgomeryMul, Mul, Exp, ExpShortVarTime, InverseVarTime, GCDVarTime, DivShortVarTime, addMulVVW, NewModulus, NewModulusProduct, Size, BitLen, Nat, newModulus, minusInverseModW, rr, bitLen, rshift1, extendedGCD
//
