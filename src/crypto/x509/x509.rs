...
// reason.
impl crate::fmt::Stringer for SignatureAlgorithm {
    // go: none — goish idiom: see the note above.
    fn String(&self) -> crate::gostring::string {
        let v = self;
        return SignatureAlgorithm::String(v);
    }
}

impl crate::fmt::Stringer for PublicKeyAlgorithm {
    // go: none — goish idiom: see the note above.
    fn String(&self) -> crate::gostring::string {
        let v = self;
        return PublicKeyAlgorithm::String(v);
    }
}
