...
// impl are now auto-generated by `#[goish::interface]` above (the
// new sentinel lives at `__NilRoundTripper` and integrates with the
// `RoundTripperRef` wrapper for nil-poly).
