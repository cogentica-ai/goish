...
//
// `reader.go`, `writer.go` and `register.go` are not ported yet. Nothing
// about them is blocked — archive/zip touches no reflect and no recover,
// and every package it imports (bufio, compress/flate, encoding/binary,
